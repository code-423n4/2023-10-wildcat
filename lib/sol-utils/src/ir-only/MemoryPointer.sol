...
library MemoryPointerLib {
  ...
  function hash(MemoryPointer mPtr, uint256 size) internal pure returns (bytes32 result) {
    assembly {
...
library MemoryReaders {
  ...
  function readMaskedUint32(MemoryPointer mPtr) internal pure returns (uint256 value) {
